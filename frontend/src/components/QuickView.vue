...
export default {
    ...
    computed: {
        ...
        selectedFood: function () {
            return this.allFoods.filter.data((f) => parseInt(f.food_id) == parseInt(this.food));
        }
    },
    ...
    methods: {
        ...
        async addToCart() {
            let existItem = await axios.get('/cart/' + parseInt(this.user.user_id) + '/' + parseInt(this.food));
