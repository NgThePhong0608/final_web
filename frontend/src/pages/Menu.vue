    ...
    <div class="menu-section">
        ...
        <div class="row">
            ...
            <div class="col-sm-8">
                <div class="row">
                    <div class="menu-tabs">
                        <input type="button" id="allFilterFoodBtn" name="allFilterFoodBtn" value="all" class="menu-tab-item"
...
export default {
    ...
    methods: {
        ...
        addItem: function (index) {
            console.log(this.currentPageItems[index].id);
            this.sendId = parseInt(this.currentPageItems[index].id);
